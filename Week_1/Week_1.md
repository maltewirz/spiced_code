...
* Making image grey: container for image relative and  absolute, then position 
...
Exercise one: Note: somewhere in this code this comes: do not repeat! `return this.width * this.heigth
...
add this to new string. punctuation etc should unchanged.
This exercise only needs to work in English.
```
